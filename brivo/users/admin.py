...
admin.site.register(models.FermentableIngredient)
admin.site.register(models.HopIngredient)
admin.site.register(models.YeastIngredient)
admin.site.register(models.ExtraIngredient)
