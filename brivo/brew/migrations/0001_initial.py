# Generated by Django 3.0.12 on 2021-03-19 06:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Modified At')),
                ('type', models.CharField(choices=[('ADJUNCT', 'Adjunct'), ('GRAIN', 'Grain'), ('DRY EXTRACT', 'Dry extract'), ('LIQUID EXTRACT', 'Liquid extract'), ('SUGAR', 'Sugar')], help_text='Fermentable type.', max_length=255, verbose_name='Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Modified At')),
                ('type', models.CharField(choices=[('ALL GRAIN', 'All Grain'), ('EXTRACT', 'Extract'), ('PARTIAL MASH', 'Partial Mash')], max_length=255, verbose_name='Type')),
                ('expected_beer_volume', django_measurement.models.MeasurementField(measurement=measurement.measures.volume.Volume, verbose_name='Expected Beer Volume')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grain_temperature', django_measurement.models.MeasurementField(measurement=measurement.measures.temperature.Temperature, null=True, verbose_name='Grain Temperature')),
                ('sparging_temperature', django_measurement.models.MeasurementField(measurement=measurement.measures.temperature.Temperature, null=True, verbose_name='Sparging Temperature')),
