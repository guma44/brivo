...
import brivo.brew.models.recipe
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=(brivo.brew.models.recipe.RecipeCalculatorMixin, models.Model),
        ),
        migrations.CreateModel(
            name='MashStep',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form', models.CharField(choices=[('DRY', 'Dry'), ('LIQUID', 'Liquid'), ('SLURRY', 'Slurry'), ('CULTURE', 'Culture')], max_length=1000, verbose_name='Form')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='yeasts', to='brew.Recipe', verbose_name='brew.models.Recipe')),
            ],
            options={
                'abstract': False,
            },
