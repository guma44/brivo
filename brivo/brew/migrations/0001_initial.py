    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, verbose_name='Name')),
                ('expected_beer_volume', django_measurement.models.MeasurementField(measurement=measurement.measures.volume.Volume, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Expected Beer Volume')),
