# Generated by Django 3.0.12 on 2021-04-13 20:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Modified At')),
                ('type', models.CharField(choices=[('ADJUNCT', 'Adjunct'), ('GRAIN', 'Grain'), ('DRY EXTRACT', 'Dry extract'), ('LIQUID EXTRACT', 'Liquid extract'), ('SUGAR', 'Sugar')], help_text='Fermentable type.', max_length=1000, verbose_name='Type')),
                ('color', django_measurement.models.MeasurementField(help_text='The color of the item.', measurement=brivo.utils.measures.BeerColor, verbose_name='Color')),
                ('extraction', models.DecimalField(decimal_places=2, help_text='Percent dry yield (fine grain) \n            for the grain, or the raw yield by weight if this is an \n            extract adjunct or sugar.', max_digits=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Extraction')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boil_loss', models.DecimalField(decimal_places=2, max_digits=5, null=True, verbose_name='Boil Waists')),
                ('primary_fermentation_start_day', models.DateField(null=True, verbose_name='Primary Fermentation Start Day')),
                ('secondary_fermentation_start_day', models.DateField(null=True, verbose_name='Secondary Fermentation Start Day')),
                ('dry_hops_start_day', models.DateField(null=True, verbose_name='Dry Hops Start Day')),
                ('post_primary_gravity', django_measurement.models.MeasurementField(measurement=brivo.utils.measures.BeerGravity, null=True, verbose_name='Post-primary Gravity')),
